const openApiSpec = {
  ...
  paths: {
    ...
    "/api/v1/auth/activate": { get: { summary: "Activate account via token" } },
    "/api/v1/auth/change-password": { post: { summary: "Change password", security: [{ bearerAuth: [] }] } },
    "/api/v1/auth/request-password-reset": { post: { summary: "Request password reset email" } },
    "/api/v1/auth/reset-password": { post: { summary: "Reset password by token" } },
    ...
    "/api/v1/users": { get: { summary: "List users", security: [{ bearerAuth: [] }] }, post: { summary: "Create user (admin)", security: [{ bearerAuth: [] }] } },
    "/api/v1/users/{id}": { get: { summary: "Get user by id", security: [{ bearerAuth: [] }] }, patch: { summary: "Update user profile", security: [{ bearerAuth: [] }] }, delete: { summary: "Delete user (admin)", security: [{ bearerAuth: [] }] } },
    "/api/v1/users/audit-logs": { get: { summary: "List audit logs", security: [{ bearerAuth: [] }] } },
